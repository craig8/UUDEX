...
@pytest.mark.asyncio
async def test_create_endpoint(endpoint_repo: EndpointRepository,
...
@pytest.mark.asyncio
async def test_select_endpoint_by_id(endpoint_repo: EndpointRepository,
                                     participant_repo: ParticipantRepository):
    participant_created = await setup_participant(participant_repo=participant_repo)
    endpoint = m.EndPointCreate(endpoint_uuid="uuid1",
                                endpoint_user_name="user1",
...
@pytest.mark.asyncio
async def test_update_endpoint(endpoint_repo: EndpointRepository,
                               participant_repo: ParticipantRepository):
    participant_created = await setup_participant(participant_repo=participant_repo)
    endpoint = m.EndPointCreate(endpoint_uuid="uuid1",
                                endpoint_user_name="user1",
...
@pytest.mark.asyncio
async def test_delete_endpoint(endpoint_repo: EndpointRepository,
                               participant_repo: ParticipantRepository):
    participant_created = await setup_participant(participant_repo=participant_repo)
    endpoint = m.EndPointCreate(endpoint_uuid="uuid1",
                                endpoint_user_name="user1",
